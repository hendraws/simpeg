...
@section('content')
    ...
    <div class="card">
        ...
        <div class="card-body">
            <form method="post" action="{{ action('PegawaiController@store') }}" enctype='multipart/form-data'>
                @csrf
                ...
                <div class="form-group row align-items-center">
                    <div class="col-sm-12">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-4">
                                <input type="number" class="form-control" id="no_hp_darurat" name="no_hp_darurat">
                            </div>
