    ...
    <div class="">
    	<div class="row justify-content-center">
    		<div class="col-md-12">
    			<div class="card">
    				<div class="card-body">
    					<form action="{{ action('PemberhentianController@update', $data->id) }}" method="POST" >
    						<div class="modal-body">
    							...
    							<div class="form-group row">
    								...
    								<div class="col-sm-8">
    									<input required type="text" class="form-control tanggal" id="tanggal_phk" value="{{ $data->tanggal_akhir }}" autocomplete="off" name="tanggal_phk">
    								</div>
    							</div>
    							<div class="form-group row">
    								...
    								<div class="col-sm-8">
    									<select class="form-control " name="jenis_pelanggaran" id="jenis_pelanggaran">
    										...
    										<option value="{{ $key }}" {{ $data->jenis_pelanggaran == $key ? 'selected' : '' }} >{{ $value }}</option>
    										@endforeach
    									</select>
    								</div>
    							</div>
    							<div class="form-group row">
    								...
    								<div class="col-sm-8">
    									<select class="form-control " name="persus" id="persus">
    										...
    										<option value="{{ $key }}" {{ $data->persus == $key ? 'selected' : '' }}>{{ $value }}</option>
    										@endforeach
    									</select>
    								</div>
    							</div>
