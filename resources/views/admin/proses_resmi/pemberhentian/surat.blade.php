...
<html>
<head>
	<title>Draft Surat Pemberhentian Kerja </title>
...
<body>
	<div class="container">
		...
		<div id="body">
			...
			<br>
			<br>
			<div>Perihal <span class="ml-100">: Surat Pemberhentian Kerja </span></div>
			<br><br>
			<div class="text-justify">Berdasarkan Evaluasi perusahaan terhadap kinerja saudara, maka Manajemen KSP Satria Mulia Arthomoro, dengan ini memberikan Surat Pemberhentian Kerja kepada :</div>
			<br><br>
			<table>
				<tr>
			...
			<div class="ml-50 text-justify">2. <span class="text-justify">Segala bentuk fasilitas perusahaan wajib dikembalikan</span></div>
			<div class="ml-50 text-justify">3. <span class="text-justify">Segala jenis kewajiban yang bersangkutan tetap wajib diselesaikan.</span></div>
			<div class="ml-50 text-justify">4. <span class="text-justify">Bentuk Pelanggaran yang mendasari keputusan ini adalah {{ $data['get_jenis_pelanggaran']['jenis_pelanggaran'] }} dikarenakan hal tersebut adalah Pelanggaran dari Persus  {{ $data['get_persus']['judul'] }}</span></div>
			<br>
