                            ...
                            <table>
                                <table>
                                    <tr>
                                        ...
                                        <td>: <input type="checkbox" value="{{ $data->surat_lamaran }}"
                                    ...
                                    <tr>
                                        ...
                                        <td>: <input type="checkbox" value={{ $data->surat_pernyataan }}
                                                {{ !empty($data->surat_pernyataan) ? 'checked' : '' }}></td>
                                    </tr>
                                    <tr>
                                        <td style="width:50%">Surat Pertanggung Jawaban</td>
                                        <td>: <input type="checkbox" value={{ $data->surat_tanggung_jawab }}
                                                {{ !empty($data->surat_tanggung_jawab) ? 'checked' : '' }}></td>
                                    </tr>
                                    <tr>
                                        <td style="width:50%">Ijazah Terakhir</td>
                                        <td>: <input type="checkbox" value={{ $data->ijazah }}
                                                {{ !empty($data->ijazah) ? 'checked' : '' }}></td>
                                    </tr>
                                    <tr>
                                        <td style="width:50%">CV</td>
                                        <td>: <input type="checkbox" value={{ $data->cv }}
                                                {{ !empty($data->cv) ? 'checked' : '' }}></td>
                                    </tr>
                                    <tr>
                                        <td style="width:50%">KTP</td>
                                        <td>: <input type="checkbox" value={{ $data->ktp }}
                                                {{ !empty($data->ktp) ? 'checked' : '' }}></td>
                                    </tr>
                                    <tr>
                                        <td style="width:50%">KK</td>
                                        <td>: <input type="checkbox" value={{ $data->kk }}
                                                {{ !empty($data->kk) ? 'checked' : '' }}> </td>
                                    </tr>
                                    <tr>
                                        <td style="width:50%">KTP Orang Tua</td>
                                        <td>: <input type="checkbox" value={{ $data->ktp_orangtua }}
                                                {{ !empty($data->ktp_orangtua) ? 'checked' : '' }}></td>
                                    </tr>
                                    @if (!empty($data->sim))
                                        <tr>
                                            <td style="width:50%">SIM</td>
                                            <td>: <input type="checkbox" value={{ $data->sim }}
                        ...
                        <div class="col-md-6">
                            <table>
                                <tr>
                                    ...
                                    <td> <input type="text" class="form-control waktu" id="tanggal_lahir" name="tanggal">
                                    </td>
                                </tr>
                            </table>
                        </div>
                    ...
                    <div class="row mt-5">
                        <div class="col-md-4">
                            <a href="{{ action('LamaranController@verifikasiLamaran', $data->id) }}"
                                class="btn btn-success col-12">Verfikasi</a>
                        </div>
                        <div class="col-md-4">
                            <a href="{{ action('LamaranController@verifikasiLamaran', $data->id) }}"
                                class="btn btn-danger col-12">Tolak</a>
                        </div>
                        <div class="col-md-4">
                            <a href="{{ action('LamaranController@verifikasiLamaran', $data->id) }}"
