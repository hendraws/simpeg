...
class Lamaran extends Model
{
    ...
    protected $with = [ 'getJabatan', 'getKantor','getUser','getAccUser'];
    ...
    public function getAccUser(){
        return $this->belongsTo(User::class, 'diterima_by', 'id');
    }
}
